# 11ty-high-performance-latex-blog

A starter repository for building a blog with the [Eleventy static site generator](https://www.11ty.dev/) implementing a wide range of performance best practices which provides a LaTeX style.
...
Based on the awesome [eleventy-high-performance-blog](https://github.com/google/eleventy-high-performance-blog).

## Demo

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fxiyueuyix%2F11ty-high-performance-latex-blog)

- [Demo](https://11ty-high-performance-latex-blog.euyix.me)

## Getting Started

### 1. Generate a new repository from this repository template

Click the ["Use this template"](https://github.com/xiyueuyix/11ty-high-performance-latex-blog/generate) button. Alternatively you can clone this repo yourself and push your copy to your favorite git repository.
...
- Defaults to the compact "classless" [LaTeX CSS framework](https://latex.vercel.app/).
- Inlines CSS.
